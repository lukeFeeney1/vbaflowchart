...
#
# However, when we do this, we also import `vbaflowchart/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'vbaflowchart_cli = vbaflowchart.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'vbaflowchart_gui = vbaflowchart.gui:entry_point'
        # ]
    }
)
